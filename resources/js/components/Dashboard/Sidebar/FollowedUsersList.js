    ...
    return (
        <div className="users-following-dashboard px-4 py-2">
            {usersPaginator == null ? (
                ...
                <div>
                    <h1 className="font-bold text-primary text-2xl text-center">People you follow</h1>
                    {usersPaginator.total > 0 ? (
                        <div>
                            <SmallUsersListWithPagination paginationData={usersPaginator} onPageChange={getUsersPage}/>
                        </div>
                    ) : (
