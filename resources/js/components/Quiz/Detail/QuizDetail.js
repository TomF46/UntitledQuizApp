        ...
        <div className="mt-6">
            ...
            <div className="p-4 flex justify-between items-center border-t">
                ...
                <div className="flex justify-right">
                    ...
                    >
                        <svg className={`${quiz.likedByUser ? "text-gray-800" : "text-black"} hover:text-gray-800 h-6 w-6" xmlns="http://www.w3.org/2000/svg`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        ...
                        className="bg-white text-whitepy-2 px-4 mr-2 inline-flex items-center"
                    >
                        <svg className={`${quiz.dislikedByUser ? "text-gray-800" : "text-black"} hover:text-gray-800 h-6 w-6" xmlns="http://www.w3.org/2000/svg`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="rounded mb-4 p-4 border-t">
                ...
                {quiz.tags && quiz.tags.length > 0 && (
                    <ul className="tagList text-center my-4">
                        {quiz.tags.map((tag) => {
                            return (
                                <li className="rounded-full py-1 px-4 bg-gray-800 hover:bg-gray-600 text-white shadow" key={tag.id}>{tag.name}</li>
                            )
                        })}
                    </ul>
                )}
