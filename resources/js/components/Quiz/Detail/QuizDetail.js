...
const QuizDetail = ({ quiz, onQuizReload, onDelete, userHighScore, isAdmin, onQuizToggleBan, onToggleRecommended, onPublish }) => {
    return (
            ...
            <div className="col-span-12 lg:col-span-3 lg:mr-4 mb-4 lg:mb-0">
                ...
                {!!quiz.recommended && (
                    <div className="flex items-center flex-shrink-0">
                        <img src="https://untitled-quiz-app-images.s3.eu-west-1.amazonaws.com/QAppRecommended38A3A5.png" alt="QApp Recommended logo" className="w-32 m-auto" />
                    </div>
                )}
                ...
                {!quiz.published && (
                    <div className="p-4 flex justify-center items-center">
                        <div className="rounded-full py-1 px-4 bg-secondary hover:opacity-75 my-1 text-white shadow">Unpublished</div>
                    </div>
                )}
                <div className="p-4">
