  ...
  return (
    <form>
          ...
          {tags && tags.length > 0 && (
            <div className='mb-2'>
              <MultiSelectInput
                ...
                error={errors.tags}
                helpText={
                  'Add as many relevant tags as possible to improve searching allowing your quiz to be found by more people.'
                }
              />
            </div>
          )}
            ...
            (quiz.userIsOwner || !quiz.id) && (
              <div className='mb-2'>
                <MultiSelectInput
                  ...
                  helpText={
                    'Collaborators can edit the quiz allowing collaboration between users. You must be friends with the user to add them as a collaborator.'
                  }
                />
              </div>
            )}
      ...
      <QuestionManagement
        ...
        errors={errors}
        setIsUpploadingImage={setUploadingImage}
      />
      <div
        id='manage-quiz-toolbar'
      ...
      >
        <div className='col-span-12 md:col-span-4 mb-2 md:mb-0'>
          <button
            ...
            className='bg-primary  text-white rounded py-2 px-4 hover:opacity-75 shadow inline-flex items-center justify-center w-full md:w-auto'
          >
            <svg
        ...
        <div className='col-span-12 md:col-span-4 mb-2 md:mb-0'>
          ...
          {uploadingImage && (
            <div className='flex text-xs text-center p-1'>
              <div>
                <svg
                  className='animate-spin text-center h-12 w-12 text-gray-800'
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
                >
