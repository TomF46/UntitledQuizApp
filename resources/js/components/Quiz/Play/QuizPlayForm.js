...
const QuizPlayForm = ({
  ...
  return (
    <div className='container mx-auto'>
      {challenge && <ChallengeInfoPanel challenge={challenge} />}
                    ...
                    {question.ordinal + 1 == currentQuestionNumber && (
                      <div className='p-4'>
                        <p className='text-center font-bold text-xl'>
                          Question {question.ordinal + 1} of{' '}
                        ...
                        {question.image_url && (
                          <div>
                            <img
                              ...
                              alt='question-image'
                              className='question-image py-16 max-w-xs md:max-w-md lg:max-w-lg'
                            />
                          </div>
                        )}
                        {question.video_url && (
                        ...
                        <div className='grid grid-cols-12 mt-4 md:flex-row'>
                          {quiz.questions[question.ordinal].answers.map(
                            (answer) => {
                              return (
                                <button
                                  type='button'
                                  key={answer.id}
                                  onClick={(e) =>
                                    onAnswerChange(question.id, answer.id, e)
                                  }
