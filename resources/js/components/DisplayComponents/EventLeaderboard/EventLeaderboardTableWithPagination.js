...
const EventLeaderboardTableWithPagination = ({ paginationData, onPageChange}) => {
    return (
        <div className="event-leaderboard-list-w-pagination">
            <EventLeaderboardTable scores={paginationData.data} startingPosition={paginationData.from} />
