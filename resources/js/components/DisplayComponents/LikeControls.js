...
const LikeControls = ({ quiz, onLikesUpdated }) => {
    ...
    return (
        <div className="flex justify-center">
            ...
            >
                <svg className={`${quiz.likedByUser ? "text-secondary" : "text-black"} hover:text-secondary h-6 w-6" xmlns="http://www.w3.org/2000/svg`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
                ...
                className="bg-white py-2 px-4 mr-2 inline-flex items-center"
            >
                <svg className={`${quiz.dislikedByUser ? "text-secondary" : "text-black"} hover:text-secondary h-6 w-6" xmlns="http://www.w3.org/2000/svg`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
