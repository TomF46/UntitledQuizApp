        ...
        return (
          ...
          >
            <div className='col-span-6 pr-4 md:pr-0 md:col-span-4 lg:col-span-3'>
              ...
              <Link
                className='font-bold items-center pointer text-secondary'
                to={`/quiz/${quiz.id}`}
              >
                {quiz.title}
              </Link>
            ...
            <div className='hidden md:inline-flex col-span-1 items-center'>
              <svg
                className={`text-success h-6 w-6" xmlns="http://www.w3.org/2000/svg`}
                fill='none'
                viewBox='0 0 24 24'
                stroke='currentColor'
              >
            ...
            <div className='hidden md:inline-flex col-span-1 items-center'>
              <svg
                className={`text-danger h-6 w-6" xmlns="http://www.w3.org/2000/svg`}
