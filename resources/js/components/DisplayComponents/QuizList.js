                ...
                return (
                    <div key={quiz.id} className="grid grid-cols-12 px-2 py-1 border-b border-gray-200 overflow-hidden">
                        <div className="col-span-6 pr-4 md:pr-0 md:col-span-4 lg:col-span-3">
                            ...
                            <Link className="font-bold items-center pointer text-secondary" to={`/quiz/${quiz.id}`}>{quiz.title}</Link>
                        </div>
                        ...
                        <div className="hidden md:inline-flex col-span-1 items-center">
                            <svg className={`text-success h-6 w-6" xmlns="http://www.w3.org/2000/svg`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5" />
                            </svg>
                            <p className="ml-1">{quiz.totalLikes}</p>
                        </div>
                        <div className="hidden md:inline-flex col-span-1 items-center">
                            <svg className={`text-danger h-6 w-6" xmlns="http://www.w3.org/2000/svg`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
