...
const Comment = ({ comment, onDeleteComment, onReload }) => {
    ...
    return (
        <div className="grid grid-cols-12 mb border-b">
            ...
            <div className="col-span-12 lg:col-span-7 p-4">{editing ? (
            ...
            <div className="col-span-12 lg:col-span-2 p-4">
                <div className="row">
                    <div className="col-span-6">
                        {comment.canEdit && (
                            <svg onClick={() => setEditing(!editing)} xmlns="http://www.w3.org/2000/svg" className={`${editing ? 'text-danger' : 'text-secondary'} h-6 w-6 pointer`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
