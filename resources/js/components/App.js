          ...
          >
            <section className='route-section'>
              <Switch location={location}>
                ...
                <AuthenticatedRoute path='/friends' component={FriendsPage} />
                <AuthenticatedRoute path='/explore' component={ExplorePage} />
                <AuthenticatedRoute
                ...
                />
                <AdminRoute path='/admin/events' component={EventsAdminPage} />
                <AdminRoute
                ...
                <AdminRoute
                  ...
                  component={TagManagementPage}
                />
                <AdminRoute path='/admin/tags' component={TagsAdminPage} />
