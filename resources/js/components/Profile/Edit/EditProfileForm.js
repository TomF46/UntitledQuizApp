...
const EditProfileForm = ({ user, onChange, onFileChange, onSave, errors = {}, saving = false }) => {
    return (
        <form className="" onSubmit={onSave}>
            <h2 className="font-bold text-primary text-4xl py-4 text-center">Edit your profile</h2>
            {errors.onSave && (
            ...
            <div id="manage-profile-toolbar" className="px-4 mt-2 flex justify-between items-center">
                <div className="flex">
                </div>
                <div className="flex">
                    {errors.onSave && (
