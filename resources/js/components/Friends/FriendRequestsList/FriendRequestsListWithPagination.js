...
const FriendRequestsListWithPagination = ({ paginationData, onPageChange, onAccept, onRemove }) => {
    return (
        <div className="Friends-list-w-pagination">
            <FriendRequestsList requests={paginationData.data} onAccept={onAccept} onRemove={onRemove} />
