        ...
        <div className='grid grid-cols-12'>
          <div className='col-span-12 lg:col-span-3 lg:mr-4 mb-4 lg:mb-0'>
            <div className='px-4 pb-4 overflow-hidden shadow page'>
              ...
              <p>
                After completing a quiz you can challenge another user to beat
                or match your score, this page shows a record of all of your
                challenges so far (challenger or recipient).
              </p>
              <p className='mt-4'>
                If your opponent matches or beats your score they get a
                challenge points if they fail you win a point towards the
                leaderboards.
              </p>
