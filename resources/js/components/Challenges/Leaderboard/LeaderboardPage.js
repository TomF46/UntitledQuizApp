...
const ChallengesLeaderboardPage = () => {
  ...
  function getChallengesLeaderboard() {
    getChallengePointsLeaderboard()
      ...
      .catch((error) => {
        toast.error(
          `Error getting challenge points leaderboard ${error.message}`,
          {
            autoClose: false,
          },
        );
      ...
      <div className='grid grid-cols-12 pb-4'>
        <div className='col-span-12 lg:col-span-3 lg:mr-4 mb-4 lg:mb-0'>
          <div className='px-4 overflow-hidden shadow page'>
            ...
            <p>
              Earn points towards your total by challenging other users to beat
              your scores or by beating users who challenge you. <br></br> If
              your opponent matches or beats your score they get a challenge
              points if they fail you win a point towards the leaderboards.
            </p>
          </div>
        </div>
            ...
            <div className='flex justify-center'>
              <div className='mb-4'>
                ...
                {!leaderboardPaginator ? (
                  <div className='flex justify-center'>
                    <LoadingMessage
                      message={'Loading challange points leaderboard'}
                    />
                  </div>
                ) : (
                  <ChallengePointsLeaderboardWithPagination
                    paginationData={leaderboardPaginator}
                    onPageChange={getChallengesLeaderboardPage}
                  />
                )}
              </div>
            </div>
