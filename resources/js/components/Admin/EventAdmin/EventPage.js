...
const EventPage = ({ eventId }) => {
    ...
    function onEnd() {
        ...
        confirmAlert({
            title: "Confirm action",
            message:  event.participantCount < 3 ? `Warning there are currently not at least 3 participants, and no trophies will be awarded. ${baseText}` : baseText,
            buttons: [
                {
                    label: "Yes",
                    onClick: () => {
                    ...
                    <div className="grid grid-cols-12 pb-4">
                        <div className="col-span-12 lg:col-span-3 lg:mr-4 mb-4 lg:mb-0">
                            <div className="px-4 pb-4 overflow-hidden shadow card">
                                ...
                                <p>
                                    <span className="font-bold">Participants:</span> {event.participantCount}
                                </p>
                            ...
                            {event.status == 1 && (
                                    <div className="px-4 pb-4 overflow-hidden shadow card mt-4">
                                        <h1 className="font-bold text-primary text-2xl text-center">Admin note</h1>
                                        <p>If you end the event before there are at least 3 participants then no trophies will be awarded.</p>
                                    </div>
                                )}
                        </div>
