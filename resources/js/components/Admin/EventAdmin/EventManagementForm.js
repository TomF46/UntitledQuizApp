    ...
    return (
        <form>
            <div className="shadow page">
                ...
                <h2 className="font-bold text-primary text-4xl py-4 text-center">{event.id ? "Edit" : "Add"} Event</h2>
                <div className="p-4">
                    <div className="mb-2">
                        <TextInput
                            name="name"
            ...
            <div id="manage-event-toolbar" className="p-4 grid grid-cols-12 shadow card mt-4">
