            ...
            <div className="grid grid-cols-12 pb-4">
                <div className="col-span-12 lg:col-span-3 lg:mr-4 mb-4 lg:mb-0 px-4 overflow-hidden shadow page">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <Link to="/admin/events" className="border border-gray-800 text-gray-800 text-center rounded py-2 px-4 mb-2 inline-flex items-center justify-center hover:opacity-75 hover:text-secondary  shadow">
